...
pub struct SpellAbilityIr {
    ...
    pub choose_from_defined_text: Option<String>,
    ...
    pub defined_cards: Option<String>,
    pub debuff: DebuffIr,
    ...
    pub token_power_text: Option<String>,
    pub token_toughness_text: Option<String>,
    ...
    pub remember_attached: bool,
    pub move_attachment: bool,
    ...
    pub static_effect_check_svar: Option<String>,
    pub static_effect_svar_compare: Option<String>,
    ...
    pub animate_power_text: Option<String>,
    pub animate_toughness_text: Option<String>,
    ...
    pub animate_remove_card_types: bool,
    pub animate_remove_super_types: bool,
    pub animate_remove_sub_types: bool,
    pub animate_remove_land_types: bool,
    pub animate_remove_artifact_types: bool,
    pub animate_remove_enchantment_types: bool,
    ...
    pub imprint_played: bool,
    pub forget_played: bool,
    ...
    pub flipper_text: Option<String>,
    pub for_each_player_text: Option<String>,
    pub save_num_flips_to_svar: Option<String>,
    pub remember_result: bool,
    pub remember_winner: bool,
    pub remember_loser: bool,
    pub remember_number_text: Option<String>,
    ...
    pub shuffle_non_mandatory: bool,
    pub warp: bool,
    pub morph: bool,
    pub morph_up: bool,
    pub megamorph: bool,
...
impl SpellAbilityIr {
    pub fn from_parsed(
        ...
        Self {
            ...
            min_amount: params.get(keys::MIN_AMOUNT).map(str::to_string),
            ...
            choose_from_defined_text: params.get(keys::CHOOSE_FROM_DEFINED).map(str::to_string),
            ...
            remember_damaged: parsed_true(params.get(keys::REMEMBER_DAMAGED)),
            ...
            defined_cards: params.get(keys::DEFINED_CARDS).map(str::to_string),
            ...
            token_power_text: params.get(keys::TOKEN_POWER).map(str::to_string),
            token_toughness_text: params.get(keys::TOKEN_TOUGHNESS).map(str::to_string),
            ...
            keep_secret: parsed_true(params.get(keys::KEEP_SECRET)),
            ...
            remember_pumped: params.has(keys::REMEMBER_PUMPED),
            ...
            remember_attached: parsed_true(params.get(keys::REMEMBER_ATTACHED)),
            move_attachment: parsed_true(params.get(keys::MOVE)),
            ...
            static_effect: params.get("StaticEffect").map(str::to_string),
            static_effect_check_svar: params.get("StaticEffectCheckSVar").map(str::to_string),
            static_effect_svar_compare: params.get("StaticEffectSVarCompare").map(str::to_string),
            ...
            adapt: params.get(keys::ADAPT).map(str::to_string),
            monstrosity: params.get(keys::MONSTROSITY).map(str::to_string),
            ...
            condition_hellbent: params.get(keys::CONDITION) == Some("Hellbent"),
            condition_threshold: params.get(keys::CONDITION) == Some("Threshold"),
            condition_metalcraft: params.get(keys::CONDITION) == Some("Metalcraft"),
            condition_delirium: params.get(keys::CONDITION) == Some("Delirium"),
            condition_revolt: params.get(keys::CONDITION) == Some("Revolt"),
            condition_desert: parsed_true(params.get("ConditionDesert")),
            condition_blessing: params.get(keys::CONDITION) == Some("Blessing"),
            ...
            set_chosen_mode: params.has("SetChosenMode"),
            ...
            animate_power_text: params.get(keys::POWER).map(str::to_string),
            animate_toughness_text: params.get(keys::TOUGHNESS).map(str::to_string),
            ...
            animate_remove_card_types: parsed_true(params.get(keys::REMOVE_CARD_TYPES)),
            animate_remove_super_types: parsed_true(params.get(keys::REMOVE_SUPER_TYPES)),
            animate_remove_sub_types: parsed_true(params.get(keys::REMOVE_SUB_TYPES)),
            animate_remove_land_types: parsed_true(params.get(keys::REMOVE_LAND_TYPES)),
            animate_remove_artifact_types: parsed_true(params.get(keys::REMOVE_ARTIFACT_TYPES)),
            animate_remove_enchantment_types: parsed_true(
                params.get(keys::REMOVE_ENCHANTMENT_TYPES),
            ),
            ...
            imprint_played: params.has("ImprintPlayed"),
            forget_played: params.has("ForgetPlayed"),
            ...
            unless_type: params.get(keys::UNLESS_TYPE).map(str::to_string),
            ...
            flipper_text: params.get("Flipper").map(str::to_string),
            for_each_player_text: params.get("ForEachPlayer").map(str::to_string),
            save_num_flips_to_svar: params.get("SaveNumFlipsToSVar").map(str::to_string),
            remember_result: params.has("RememberResult"),
            remember_winner: params.has("RememberWinner"),
            remember_loser: params.has("RememberLoser"),
            remember_number_text: params.get("RememberNumber").map(str::to_string),
            ...
            shuffle_non_mandatory: params.has(keys::SHUFFLE_NON_MANDATORY),
