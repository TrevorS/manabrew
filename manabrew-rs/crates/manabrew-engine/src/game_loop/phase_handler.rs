...
impl GameLoop {
            ...
            state = match state {
                TurnMachineState::Untap => {
                    ...
                    if game.player(active).skip_next_untap {
                        ...
                        next_turn_machine_state(game, &mut self.trigger_handler, PhaseType::Untap)
                    } else {
                ...
                TurnMachineState::Upkeep => {
                    ...
                    next_turn_machine_state(game, &mut self.trigger_handler, PhaseType::Upkeep)
                }
                TurnMachineState::Draw => {
                        ...
                        )
                    {
                        ...
                        next_turn_machine_state(game, &mut self.trigger_handler, PhaseType::Draw)
                    } else {
                ...
                TurnMachineState::Main1 => {
                    ...
                    next_turn_machine_state(game, &mut self.trigger_handler, PhaseType::Main1)
                }
                TurnMachineState::Combat => {
                    ...
                    next_turn_machine_state(game, &mut self.trigger_handler, PhaseType::CombatEnd)
                }
                TurnMachineState::Main2 => {
                    ...
                    next_turn_machine_state(game, &mut self.trigger_handler, PhaseType::Main2)
                }
                TurnMachineState::EndOfTurn => {
                    ...
                    next_turn_machine_state(game, &mut self.trigger_handler, PhaseType::EndOfTurn)
                }
    ...
    pub(crate) fn fire_combat_damage_triggers(
        ...
        let mut by_target: indexmap::IndexMap<Target, i32> = indexmap::IndexMap::new();
        let mut maps_by_target: indexmap::IndexMap<Target, CardDamageMap> =
...
fn next_turn_machine_state(
    game: &mut GameState,
    trigger_handler: &mut TriggerHandler,
    ended: PhaseType,
) -> TurnMachineState {
    let next = match game.turn.pop_extra_phase(ended) {
        Some(extra_phase) => {
            for deltrig in extra_phase.get_delayed_triggers() {
                trigger_handler.register_this_turn_delayed_trigger(deltrig.clone());
            }
            extra_phase.get_phase()
        }
        None => ended.next(),
    };
    match next {
        PhaseType::Untap => TurnMachineState::Untap,
        PhaseType::Upkeep => TurnMachineState::Upkeep,
        PhaseType::Draw => TurnMachineState::Draw,
        PhaseType::Main1 => TurnMachineState::Main1,
        PhaseType::Main2 => TurnMachineState::Main2,
        PhaseType::EndOfTurn => TurnMachineState::EndOfTurn,
        PhaseType::Cleanup => TurnMachineState::Cleanup,
        _ => TurnMachineState::Combat,
    }
}
