            ...
            state = match state {
                TurnMachineState::Untap => {
                    ...
                    if game.player(active).skip_next_untap {
                        ...
                        next_turn_machine_state(game, PhaseType::Untap)
                    } else {
                ...
                TurnMachineState::Upkeep => {
                    ...
                    next_turn_machine_state(game, PhaseType::Upkeep)
                }
                TurnMachineState::Draw => {
                        ...
                        )
                    {
                        ...
                        next_turn_machine_state(game, PhaseType::Draw)
                    } else {
                ...
                TurnMachineState::Main1 => {
                    ...
                    next_turn_machine_state(game, PhaseType::Main1)
                }
                TurnMachineState::Combat => {
                    ...
                    next_turn_machine_state(game, PhaseType::CombatEnd)
                }
                TurnMachineState::Main2 => {
                    ...
                    next_turn_machine_state(game, PhaseType::Main2)
                }
                TurnMachineState::EndOfTurn => {
                    ...
                    next_turn_machine_state(game, PhaseType::EndOfTurn)
                }
...
fn next_turn_machine_state(game: &mut GameState, ended: PhaseType) -> TurnMachineState {
    match game.turn.next_phase_after(ended) {
