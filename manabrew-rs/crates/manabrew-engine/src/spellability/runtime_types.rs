...
impl AbilityDuration {
    pub fn parse(raw: &str) -> Self {
        match raw {
            ...
            "UntilTheEndOfYourNextTurn" => Self::UntilTheEndOfYourNextTurn,
            "UntilEndOfCombat" => Self::UntilEndOfCombat,
            "UntilNextEndStep" => Self::UntilNextEndStep,
            "UntilYourNextEndStep" => Self::UntilYourNextEndStep,
            "UntilFacedown" => Self::UntilFacedown,
