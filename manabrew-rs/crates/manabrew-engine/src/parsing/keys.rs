...
pub const MAY_PLAY_PLAYER: &str = "MayPlayPlayer";
pub const MAY_PLAY_LIMIT: &str = "MayPlayLimit";
pub const MAY_PLAY_TEXT: &str = "MayPlayText";
pub const MAY_PLAY_ALT_MANA_COST: &str = "MayPlayAltManaCost";
pub const MAY_PLAY_WITHOUT_MANA_COST: &str = "MayPlayWithoutManaCost";
...
pub const TARGET_UNIQUE: &str = "TargetUnique";
...
pub const ADD_SVARS: &str = "AddSVars";
pub const ADD_TRIGGERS: &str = "AddTriggers";
pub const ADD_ABILITIES: &str = "AddAbilities";
pub const ADD_STATIC_ABILITIES: &str = "AddStaticAbilities";
pub const GAIN_TEXT_ABILITIES: &str = "GainTextAbilities";
...
pub const CHOOSE_FROM_DEFINED: &str = "ChooseFromDefined";
...
pub const REMEMBER_ATTACHED: &str = "RememberAttached";
...
pub const REMEMBER_KEPT: &str = "RememberKept";
...
pub const REMEMBER_MOVED: &str = "RememberMoved";
