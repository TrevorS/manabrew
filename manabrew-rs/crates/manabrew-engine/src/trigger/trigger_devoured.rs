...
pub struct TriggerDevoured {
    pub valid_card: Option<crate::parsing::CompiledSelector>,
}

impl TriggerDevoured {
    pub fn parse(params: &Params) -> Box<dyn TriggerBehavior> {
        Box::new(Self {
            valid_card: params.selector_cloned_any(&["ValidDevoured", keys::VALID_CARD]),
        })
    }
}

#[typetag::serde]
impl TriggerBehavior for TriggerDevoured {
    fn trigger_type(&self) -> TriggerType {
        TriggerType::Devoured
    }
