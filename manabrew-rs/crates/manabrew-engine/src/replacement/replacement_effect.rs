...
pub struct ReplacementEffectIr {
    ...
    pub valid_stack_sa_text: Option<String>,
    ...
    pub damage_target_text: Option<String>,
...
impl ReplacementEffectIr {
    fn from_params(params: &Params) -> Self {
        Self {
            ...
            valid_stack_sa_text: params.get("ValidStackSa").map(str::to_string),
            ...
            damage_target_text: params.get("DamageTarget").map(str::to_string),
            ...
            fizzle: parsed_bool(params.get("Fizzle")),
