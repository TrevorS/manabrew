...
use parity::java_bridge::JavaMatchupData;
...
const REGRESSION_JSON_PATH: &str = "manabrew-rs/crates/parity/regression.json";
...
impl App {
    ...
    fn current_cli_command(&self) -> String {
        ...
        let mut args = vec![
            "cargo run -p parity --bin parity --".to_string(),
    ...
    ui.horizontal(|ui| {
        ...
        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                ...
                .clicked()
            {
                ...
                app.trace_status = Some("Copied parity CLI command".to_string());
            }
...
fn render_snapshot_player_block(
    ui: &mut egui::Ui,
    player: &parity::protocol::PlayerSnapshot,
    other: Option<&parity::protocol::PlayerSnapshot>,
    active_player: u32,
    archive: Option<&ArchiveState>,
    selected_card_name: Option<&str>,
    selected_card: &mut Option<InspectedCard>,
...
fn render_decision_event_card(ui: &mut egui::Ui, decision: &parity::protocol::DecisionRecord) {
    render_event_card_frame(
        ui,
        theme::ACCENT,
        "PRIORITY",
