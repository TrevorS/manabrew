...
| `src/explain.rs`                                                    | `parity explain` and `parity gate-summary`: read a finished `--format json` report or gate file instead of rerunning.                                                                                                                                                                                                                                                                                                                                                                                                                                |
